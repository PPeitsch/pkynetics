...
class TestHorowitzMetzgerMethod(unittest.TestCase):
    ...
    def test_horowitz_metzger_method_accuracy(self):
        ...
        self.assertLess(abs(e_a / 1000 - self.true_e_a / 1000), 30)  # Compare in kJ/mol, allow 30 kJ/mol difference
    ...
    def test_horowitz_metzger_method_with_noise(self):
        ...
        self.assertGreater(e_a, 0)  # Activation energy should be positive
        self.assertLess(abs(e_a / 1000 - self.true_e_a / 1000), 40)  # Allow larger difference with noise
        self.assertLess(abs(np.log10(a) - np.log10(self.true_a)), 4)  # Allow larger difference in order of magnitude
    ...
    def test_non_first_order_reaction(self):
        ...
        self.assertGreater(e_a, 0)  # Activation energy should be positive
        self.assertLess(abs(e_a / 1000 - self.true_e_a / 1000), 120)  # Allow 120 kJ/mol difference for non-first order
        self.assertLess(abs(np.log10(a) - np.log10(self.true_a)), 7)  # Compare order of magnitude
        self.assertGreater(r_squared, 0.9)  # R-squared should still be relatively high
    ...
    def test_edge_cases(self):
        ...
        self.assertLess(e_a / 1000, 100)  # Fitted E_a should be relatively low (< 100 kJ/mol)

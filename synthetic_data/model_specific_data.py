...
def generate_ofw_data(e_a: float, a: float, heating_rates: List[float], 
                      t_range: Tuple[float, float], noise_level: float = 0) -> Tuple[List[np.ndarray], List[np.ndarray]]:
    """
...
def generate_friedman_data(e_a: float, a: float, heating_rates: List[float], 
                           t_range: Tuple[float, float], noise_level: float = 0) -> Tuple[List[np.ndarray], List[np.ndarray], List[np.ndarray]]:
    """
    ...
    Returns:
        Tuple[List[np.ndarray], List[np.ndarray], List[np.ndarray]]: Temperature data, conversion data, and conversion rate data for each heating rate
    """
    temp_data, conv_data = generate_basic_kinetic_data(e_a, a, heating_rates, t_range, 
                                                       reaction_model='first_order', noise_level=noise_level)
